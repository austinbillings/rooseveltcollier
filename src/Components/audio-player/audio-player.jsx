  ...
  render () {
    return (
      <box className={this.getClassName()}>
        ...
        <time className="Audio-Time">{this.state.time}</time>
        <ProgressBar height={5} color={'#555'} className="Audio-Progress" percent={this.state.position} interactive onScrub={this.handleScrub} />
      </box>
    )
  }
};
